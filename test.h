...
extern void print_box(int, int, char);
extern void print_dot(int, int, char);
extern void print_bar(int bar_x);

extern void delete_bar(int x, int y, int bar_x);
extern void print_block(int);
extern void del_block(int a);
